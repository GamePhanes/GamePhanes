const translations = {
  en: {
    ...
    heroStatement: "Code. Run. Receive feedback. Repair.",
    heroCopy: "Godot-first runtime feedback infrastructure for game coding agents. The game is the executable test surface, not the agent's gameplay policy.",
    ...
    proofLead: "GamePhanes launches the agent-modified project, probes it with evaluator-controlled inputs, observes runtime state, and returns deterministic feedback for repair.",
    ...
    showcaseLead: "Each slice is a runnable feedback environment with an external harness, observable state, and deterministic score.",
    ...
    workflowTitle: "From code change to actionable feedback.",
    ...
    workflowPlay: "Exercise",
    workflowInputs: "Evaluator probe",
    ...
    systemsTitle: "Run the artifact. Return feedback. Enable repair.",
  ...
  zh: {
    ...
    heroStatement: "修改代码，运行验证，获得反馈，继续修复。",
    heroCopy: "面向游戏 Coding Agent 的 Godot-first 运行时反馈基础设施。游戏是可执行测试面，不是 Agent 要学习的操作策略。",
    ...
    proofLead: "GamePhanes 启动 Agent 修改后的工程，由评测器控制输入、观测运行时状态，并返回可用于修复的确定性反馈。",
    ...
    showcaseLead: "每个切片都是可运行的反馈环境，具备外部 Harness、可观测状态和确定性评分。",
    ...
    workflowPlay: "执行验证",
    workflowInputs: "评测器探针",
    workflowObserve: "观测",
    workflowState: "状态与日志",
    workflowRepair: "修复",
    workflowEvidence: "基于证据",
    systemsKicker: "为智能体设计",
    systemsTitle: "运行产物，返回反馈，支持修复。",
